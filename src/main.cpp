...
#if defined(NDEBUG)
# error "Bigup cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Bigup Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    {
		nSubsidy = 400000000 * COIN;  // 400mil
    } 
...
#ifdef ENABLE_WALLET
// Bigup: attempt to generate suitable proof-of-stake
